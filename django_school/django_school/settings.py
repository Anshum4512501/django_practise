...
TEMPLATE_DIR = os.path.join(BASE_DIR,'django_school','templates')
...
SECRET_KEY = '^a^!3t-t7x(%cm1ul)tp2d6t&@jvozayf+ijdxcwn4l-9))1*8'
...
LOGIN_REDIRECT_URL = '/school/school_list/'
